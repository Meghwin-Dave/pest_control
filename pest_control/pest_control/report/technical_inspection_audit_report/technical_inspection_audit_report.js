...
frappe.query_reports["Technical Inspection Audit Report"] = {
	"filters": [
		{
			"fieldname": "from_date",
			"label": __("From Date"),
	...
	"formatter": function(value, row, column, data, default_formatter) {
		...
		// Make visit ID clickable
		if (column.fieldname === "visit_id") {
			value = `<a href="/app/maintenance-visit/${data.visit_id}" style="color: #5e64ff;">${value}</a>`;
		}
